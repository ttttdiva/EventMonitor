...
def fix_huggingface_urls(repo_name: str = "disguisequence/EventMonitor_1", dry_run: bool = False, 
...
def main():
    ...
    parser.add_argument(
        '--repo',
        default='disguisequence/EventMonitor_1',
        help='HuggingFaceリポジトリ名（デフォルト: disguisequence/EventMonitor_1）'
    )
    parser.add_argument(
        '--table',
